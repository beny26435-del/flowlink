...
/// @title FlowLinkV3
/// @notice Native Arc USDC checkout links with public slugs and creator profiles.
...
contract FlowLinkV3 {
    ...
    function payLinkBySlug(string calldata slug) external payable nonReentrant {
        _payLink(_requireSlug(slug), msg.sender, msg.value);
    }
    ...
    function contributeGroupBySlug(string calldata slug) external payable nonReentrant {
        _contributeGroup(_requireSlug(slug), msg.sender, msg.value);
    }
    ...
    function refundGroupBySlug(string calldata slug) external nonReentrant {
        _refundGroup(_requireSlug(slug), msg.sender);
    }
    ...
    function cancelLinkBySlug(string calldata slug) external {
        _cancelLink(_requireSlug(slug), msg.sender);
    }
